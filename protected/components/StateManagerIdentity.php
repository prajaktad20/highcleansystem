 ...
 */
class StateManagerIdentity extends CUserIdentity
{
	private $_id;	
	...
	$users = StateManager::model()->findByAttributes(array(),
	...
	if($users===null) {
		...
		$this->_id = $users->id;
		$this->username = 'state_manager';
		$this->setState('profile', 'state_manager');           
