...
class JobEmailNotification extends CApplicationComponent {

    public static function sendEmail($email_temp_id, $job_id, $supervisor_id, $site_supervisor_id) {
         ...
         *  E-mail Formatting
         */
        $EmailFormatting = JobEmailNotification::emailFormatting($email_temp_id, $job_id, $supervisor_user_model, $site_supervisor_user_model);
        ...
        $to = trim($job_model->client_email);
        $toname = trim($job_model->client_name);
        ...
        JobEmailNotification::sendMailThroughMailgun($email_temp_id, $from, $fromheader, $to, $toname, $sub, $mail, $header, $supervisor_user_model->email);
    ...
    public static function emailFormatting($email_temp_id, $job_id, $supervisor_user_model, $site_supervisor_user_model) {
        ...
        $sign_off_name = '<span style="">' . $job_model->client_name . '</span>';
        $client_first_name = '<span style="">' . $job_model->client_name . '</span>';
        $notes_to_client = '<span style="">' . $job_model->note_for_client . '</span>';
        ...
        $cleaning_report_link = Yii::app()->getBaseUrl(true) . '/?r=site/JobImages&qid=' . $job_model->quote_id . '&jobid=' . $job_id;
        ...
        $EmailFormat_changes_tags_value = array(
            ...
            "{cleaning_report_link}" => $cleaning_report_link,
        );
    ...
    public static function sendMailThroughMailgun($email_temp_id, $from, $fromheader, $to, $toname, $sub, $mail, $header, $supervisor_email_address =null) {
