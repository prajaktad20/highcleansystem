...
/**
 * This is the model class for table "{{list_pane_size_type}}".
 *
 * The followings are the available columns in table '{{list_pane_size_type}}':
 * @property integer $id
 ...
 */
class ListPaneSizeType extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('name, list_item_id, time_per_quantity, setup_time, status', 'required'),
	 ...
	 * @return ListPaneSizeType the static model class
	 */
