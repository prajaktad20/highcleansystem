...
switch($logined_user_role) {
	...
	$profile_url = $this->user_role_base_url."?r=User/personal/MyPersonalDetails";
	break;
...
<a href="<?php echo $this->user_role_base_url; ?>?r=ClientDashboard" class="logo"><?php echo $left_header_title; ?></a>
