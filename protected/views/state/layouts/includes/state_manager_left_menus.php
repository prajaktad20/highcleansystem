...
$StateManager =array();
$StateManager[] = 'StateManager/personal/MyPersonalDetails';
$StateManager[] = 'StateManager/personal/ChangeMyPassword';

?>

<?php if(in_array($request_url,$StateManager )) { ?>

<li class="parent parent-focus"><a href="<?php echo $this->user_role_base_url; ?>?r=StateManager/personal/MyPersonalDetails" ><i class="fa fa-user fa-fw"></i> &nbsp;  <span>My Profile</span></a>
<ul class="children" style="display:block">
        <li <?php if($request_url === 'StateManager/personal/MyPersonalDetails') echo 'class="active"'; ?> ><a href="<?php echo $this->user_role_base_url; ?>?r=StateManager/personal/MyPersonalDetails"><i class="fa fa-user fa-fw"></i> &nbsp; Personal details</a></li>
     	<li <?php if($request_url === 'StateManager/personal/ChangeMyPassword') echo 'class="active"'; ?> ><a href="<?php echo $this->user_role_base_url; ?>?r=StateManager/personal/ChangeMyPassword"><i class="fa fa-user fa-fw"></i> &nbsp; Change Password</a></li>
      </ul>
   </li>

<?php } else { ?>

<li class="parent "><a href="<?php echo $this->user_role_base_url; ?>?r=StateManager/personal/MyPersonalDetails" ><i class="fa fa-user fa-fw"></i> &nbsp;  <span>My Profile</span></a>
      <ul class="children">
        <li><a href="<?php echo $this->user_role_base_url; ?>?r=StateManager/personal/MyPersonalDetails"><i class="fa fa-user fa-fw"></i> &nbsp; Personal details</a></li>
       <li><a href="<?php echo $this->user_role_base_url; ?>?r=StateManager/personal/ChangeMyPassword"><i class="fa fa-user fa-fw"></i> &nbsp; Change Password</a></li>
      </ul>
   </li>
<?php } ?>
