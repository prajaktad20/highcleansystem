...
switch($logined_user_role) {
	...
	$profile_url = $this->user_role_base_url."?r=SystemOwner/personal/MyPersonalDetails";
	break;
}
...
<?php if( isset(Yii::app()->user->agent_id) &&  !empty(Yii::app()->user->agent_id) && isset($this->agent_info)) { ?>
<li><a href="<?php echo $this->user_role_base_url."?r=SystemOwner/personal/logoutAgentPanel"; ?>"><i class="glyphicon glyphicon-log-out"></i>Sign Out Agent Panel</a></li>
<?php } else { ?>
