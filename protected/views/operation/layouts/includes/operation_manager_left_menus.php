...
<li class="parent parent-focus"><a href="<?php echo $this->user_role_base_url; ?>?r=Report/default/job_profitability"><i class="fa fa-barcode fa-fw"></i> &nbsp;  <span>Report</span></a>
	<ul class="children" style="display:block">
	<li <?php if($request_url === 'Report/default/job_profitability') echo 'class="active"'; ?> ><a href="<?php echo $this->user_role_base_url; ?>?r=Report/default/job_profitability"><i class="fa fa-barcode fa-fw"></i> &nbsp;  <span>Job profitability</span></a></li>
	</ul>
</li> 	
	  
<?php } else { ?>
<li class="parent "><a href="<?php echo $this->user_role_base_url; ?>?r=Report/default/job_profitability"><i class="fa fa-barcode fa-fw"></i> &nbsp;  <span>Report</span></a>
	<ul class="children">
	<li ><a href="<?php echo $this->user_role_base_url; ?>?r=Report/default/job_profitability"><i class="fa fa-barcode fa-fw"></i> &nbsp;  <span>Job profitability</span></a></li>
	</ul>
</li> 	
...
$OperationManager[] = 'OperationManager/personal/MyPersonalDetails';
$OperationManager[] = 'OperationManager/personal/ChangeMyPassword';

?>

<?php if(in_array($request_url,$OperationManager )) { ?>

<li class="parent parent-focus"><a href="<?php echo $this->user_role_base_url; ?>?r=OperationManager/personal/MyPersonalDetails" ><i class="fa fa-user fa-fw"></i> &nbsp;  <span>My Profile</span></a>
<ul class="children" style="display:block">
        <li <?php if($request_url === 'OperationManager/personal/MyPersonalDetails') echo 'class="active"'; ?> ><a href="<?php echo $this->user_role_base_url; ?>?r=OperationManager/personal/MyPersonalDetails"><i class="fa fa-user fa-fw"></i> &nbsp; Personal details</a></li>
     	<li <?php if($request_url === 'OperationManager/personal/ChangeMyPassword') echo 'class="active"'; ?> ><a href="<?php echo $this->user_role_base_url; ?>?r=OperationManager/personal/ChangeMyPassword"><i class="fa fa-user fa-fw"></i> &nbsp; Change Password</a></li>
      </ul>
   </li>

<?php } else { ?>

<li class="parent "><a href="<?php echo $this->user_role_base_url; ?>?r=OperationManager/personal/MyPersonalDetails" ><i class="fa fa-user fa-fw"></i> &nbsp; My Profile</span></a>
      <ul class="children">
        <li><a href="<?php echo $this->user_role_base_url; ?>?r=OperationManager/personal/MyPersonalDetails"><i class="fa fa-user fa-fw"></i> &nbsp; Personal details</a></li>
       <li><a href="<?php echo $this->user_role_base_url; ?>?r=OperationManager/personal/ChangeMyPassword"><i class="fa fa-user fa-fw"></i> &nbsp; Change Password</a></li>
      </ul>
   </li>
<?php } ?>
