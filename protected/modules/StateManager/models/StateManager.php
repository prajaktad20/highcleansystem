...
/**
 * This is the model class for table "{{state_manager}}".
 *
 * The followings are the available columns in table '{{state_manager}}':
 * @property integer $id
 ...
 */
class StateManager extends CActiveRecord
{
	 ...
	 * @return StateManager the static model class
	 */
