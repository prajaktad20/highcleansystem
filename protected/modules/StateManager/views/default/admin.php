...
<div class="pageheader">
        <div class="media">
          <div class="media-body">
            <ul class="breadcrumb">
         	 <li>Manage State Manager</li>
            </ul>
            <h4>
<?php
					  
					  echo CHtml::link(
						Yii::t("StateManager.create", "Add New State Manager"),
						array("create"),
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	array(
		...
		array(
			...
			'template'=>'{state_manager_login} | {view} | {update} | {delete} | {change_password}',
			'buttons'=>array
						(
							'state_manager_login' => array
							(
								'label'=>'Login',
								'imageUrl'=>false,
							),
                            ...
                            (
                                ...
                                'imageUrl' => false,
                                'url' => 'Yii::app()->createUrl("/StateManager/default/changepassword",array("id" => $data->primaryKey))',
                            ),
