...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'site_contact'); ?>
		<?php echo $form->textField($model,'site_contact',array('size'=>60,'maxlength'=>255)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'site_comments'); ?>
		<?php echo $form->textField($model,'site_comments',array('size'=>60,'maxlength'=>255)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'how_many_buildings'); ?>
		<?php echo $form->textField($model,'how_many_buildings'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'need_induction'); ?>
		<?php echo $form->textField($model,'need_induction',array('size'=>1,'maxlength'=>1)); ?>
	</div>
