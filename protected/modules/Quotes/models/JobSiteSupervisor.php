...
/**
 * This is the model class for table "{{job_site_supervisor}}".
 *
 * The followings are the available columns in table '{{job_site_supervisor}}':
 * @property integer $id
 ...
 */
class JobSiteSupervisor extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('date_on_signed, signature, job_date, msg_sent_date_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, job_id, agent_id, place_to_come, user_id, name, email, phone, mobile, date_on_signed, signature, job_date, day_night, msg_sent_text, msg_replied_text, msg_sent_status, msg_replied_status, msg_sent_date_time, msg_replied_when, msg_id, msg_sms_service_used', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return JobSiteSupervisor the static model class
	 */
