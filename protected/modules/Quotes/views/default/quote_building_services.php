...
<div class="contentpanel">
  <div class="row">
    ...
    <div class="col-md-12 quote_section">
      ...
      <div class="col-md-12">
        <button id="<?php echo $buiding_single_row['job_id']; ?>"  data-toggle="modal" data-target="#myModal"  class="add_new_service btn btn-primary mr5"  onclick="return false;" > Add New Service for Building "<?php echo $buiding_single_row['building_name']; ?>"</button>
        <div class="table-responsive">
          <div class="col-md-12">
    <?php 
	
	$model=new QuoteJobServices('search');
	$model->unsetAttributes();  // clear any default values
	$model->job_id = $buiding_single_row['job_id'];

        $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'building-grid-'.$buiding_single_row['job_id'],
			...
			'buttons'=>array
					...
					'upload' => array
							(
								'label'=>'Upload Image', 
								'imageUrl'=>false,																
				 				'url' => 'Yii::app()->createUrl("/Quotes/default/GetQuoteBuldingColumnsImage",array("id" => $data->primaryKey,"rid" => rand() ))',
								'click' => 'function(e) {
                                      $("#ajaxModal").remove();
                                      e.preventDefault();
                                      var $this = $(this)
 ...
 'edit' => array( // My custom button options
        ...
        <div class="col-md-6 mb30">
          ...
          <textarea cols="80" rows="4"  id="editor2" class="form-control mb20" name="staff_contr[<?php echo $buiding_single_row['job_id']; ?>]"><?php if(isset($buiding_single_row['si_staff_contractor'])) echo $buiding_single_row['si_staff_contractor']; ?>
</textarea>
          <div class="panel panel-default">
            <div class="panel-body titlebar"> <span class="glyphicon  glyphicon-th"></span>
...
$post_swms_ids = array();
if(! empty($buiding_single_row['swms_ids']))
$post_swms_ids = explode(',',$buiding_single_row['swms_ids']);

?>
              <li>
                <input  <?php if(in_array($RowSWMStypes->id, $post_swms_ids)) echo 'checked';  ?>  type="checkbox" value="<?php echo $RowSWMStypes->id; ?>" name="swms[<?php echo $buiding_single_row['job_id']; ?>][]">
        ...
        <div class="col-md-6">
          ...
          <textarea  cols="80" rows="4" id="editor1" class="form-control mb20" name="client[<?php echo $buiding_single_row['job_id']; ?>]"><?php if(isset($buiding_single_row['si_client'])) echo $buiding_single_row['si_client']; ?>
</textarea>
          <div class="panel panel-default">
            <div class="panel-body titlebar"> <span class="glyphicon  glyphicon-th"></span>
...
if(! empty($buiding_single_row['tool_types_ids']))
$post_tooltypes_ids = explode(',',$buiding_single_row['tool_types_ids']);
?>
              <?php 
$Criteria = new CDbCriteria();
...
?>
              ...
              <li>
                <input <?php if(in_array($RowToolTypes->id, $post_tooltypes_ids)) echo 'checked';  ?>  type="checkbox" value="<?php echo $RowToolTypes->id; ?>" name="tool_types[<?php echo $buiding_single_row['job_id']; ?>][]">
    ...
    <?php } ?>
    <div class="row buttons aligncenter"> <a href="<?php echo $this->user_role_base_url.'/?r=Quotes/default/update&id='.$_REQUEST['qid']; ?>" class="btn btn-primary mr5">Back</a> <?php echo CHtml::submitButton('Save & Continue', array('class' => 'btn btn-primary')); ?> </div>
  </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="job_id" value="" class="form-control" />
...
<script type="text/javascript">    CKEDITOR.replace( 'editor2',
