...
class DefaultController extends Controller
{
 ...
 public $user_role_base_url = ''; public $user_dashboard_url = '';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['SmsFormat']))
		{
			$model->attributes=$_POST['SmsFormat'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('SmsFormat');
	...
	{
		$model=new SmsFormat('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SmsFormat']))
			$model->attributes=$_GET['SmsFormat'];
	...
	{
		$model=SmsFormat::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param SmsFormat $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sms-format-form')
		{
