...
class DefaultController extends Controller
{
 ...
 public $user_role_base_url = ''; public $user_dashboard_url = '';
	...
	{
		$model=new LicencesType;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['LicencesType']))
		{
			$model->attributes=$_POST['LicencesType'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('LicencesType');
	...
	public function actionAdmin()
	{
		...
		$model=new LicencesType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['LicencesType']))
			$model->attributes=$_GET['LicencesType'];
	 ...
	 * @return LicencesType the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=LicencesType::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param LicencesType $model the model to be validated
	 */
