...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->textField($model,'pay_date',array('size'=>60,'maxlength'=>255,'class'=>'form-control','id'=>'pay_date')); ?>
	...
	<td>
	<div class="createselect2 mr30">
	<?php echo $form->textField($model,'payment_start_date',array('size'=>60,'maxlength'=>255,'class'=>'form-control','id'=>'payment_start_date')); ?>
	...
	<td>
	<div class="createselect2 mr30">
	<?php echo $form->textField($model,'payment_end_date',array('size'=>60,'maxlength'=>255,'class'=>'form-control','id'=>'payment_end_date')); ?>
