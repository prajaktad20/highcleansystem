...
<?php $path = Yii::app()->basePath.'/../uploads/users-profile-images/thumbs/'; ?>	
<?php if(isset($model->Avatar) && $model->Avatar !=NULL && file_exists($path.$model->Avatar))	 { ?>
<div class="form-group">
		<label class="col-sm-5">&nbsp;</label>
		 <div class="col-sm-7">
		<img  src="<?php echo Yii::app()->getBaseUrl(true).'/uploads/users-profile-images/thumbs/'.$model->Avatar; ?>" alt=""> 
		</div>
</div>
<?php }  ?>
