...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('view_jobs')); ?>:</b>
	<?php echo CHtml::encode($data->view_jobs); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('interested_in')); ?>:</b>
	<?php echo CHtml::encode($data->interested_in); ?>
	<br />
