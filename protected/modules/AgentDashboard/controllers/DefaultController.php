...
class DefaultController extends Controller
{
	...
	public $agent_info = null;
		...
		if(empty($agent_id) && in_array(Yii::app()->user->name,array('system_owner', 'state_manager', 'operation_manager'))) {
			$referred_agent_id = isset($_GET['referred_agent_id']) ? $_GET['referred_agent_id'] : 0;

			if($referred_agent_id == 0) 
			throw new CHttpException(404,'The requested page does not exist.');

			Yii::app()->user->setState('agent_id',$referred_agent_id);
		}
